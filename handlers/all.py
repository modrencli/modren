...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/"+u3311)],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/vv02vv")],[InlineKeyboardButton("قناة البوت 🤖", url="t.me/u3311")]])
